...
class AddProductControllerFixture extends AbstractFixture
{
    ...
    {
        $products = [
            new Product('fbcb8c51-5dcc-4fd4-a4cd-ceb9b400bff7', 'Product 1', 1990, new DateTimeImmutable()),
            new Product('9670ea5b-d940-4593-a2ac-4589be784203', 'Product 2', 3990, new DateTimeImmutable()),
            new Product('15e4a636-ef98-445b-86df-46e1cc0e10b5', 'Product 3', 4990, new DateTimeImmutable()),
            new Product('00e91390-3af8-4735-bd06-0311e7131757', 'Product 4', 5990, new DateTimeImmutable()),
        ];
